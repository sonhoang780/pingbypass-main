                            ...
                            if (args[0].equalsIgnoreCase("add")) {
                                if (setting.getType() == WhitelistSetting.Type.ITEMS) {
                                    ...
                                    if (setting.isWhitelistContains(item)) {
                                        EUClient.CHAT_MANAGER.tagged(ChatUtils.getPrimary() + item.getName(item.getDefaultInstance()).getString() + ChatUtils.getSecondary() + " is already on the whitelist.", module.getName(), "module-cmd-" + getName());
                                    } else {
                                        setting.add(item);
                                        EUClient.CHAT_MANAGER.tagged("Successfully added " + ChatUtils.getPrimary() + item.getName(item.getDefaultInstance()).getString() + ChatUtils.getSecondary() + " to the whitelist.", module.getName(), "module-cmd-" + getName());
                                    }
                                ...
                                if (setting.getType() == WhitelistSetting.Type.ITEMS && (item = IdentifierUtils.getItem(args[1])) != null && setting.isWhitelistContains(item)) {
                                    setting.remove(item);
                                    EUClient.CHAT_MANAGER.tagged("Successfully removed " + ChatUtils.getPrimary() + item.getName(item.getDefaultInstance()).getString() + ChatUtils.getSecondary() + " from the whitelist.", module.getName(), "module-cmd-" + getName());
                                ...
                                if (setting.getWhitelist().isEmpty()) {
                                    ...
                                    for (Object object : setting.getWhitelist()) {
                                        ...
                                        switch (object) {
                                            ...
                                            case Item item -> whitelist.append(item.getName(item.getDefaultInstance()).getString());
