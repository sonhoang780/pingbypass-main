...
public class ColorButton extends Button {
    ...
    public void render(GuiGraphicsExtractor context, int mouseX, int mouseY, float delta) {
        ...
        Renderer2D.renderQuad(context, getX() + getWidth() - getPadding() - 9, getY() + 2, getX() + getWidth() - getPadding() - 1, getY() + getParent().getHeight() - 3, ColorUtils.getColor(setting.getColor(), 255));
        Renderer2D.renderOutline(context, getX() + getWidth() - getPadding() - 9, getY() + 2, getX() + getWidth() - getPadding() - 1, getY() + getParent().getHeight() - 3, outlineColor);

        if(open) {
            int offset = getParent().getHeight();

            int dragX = Mth.clamp(mouseX - getX() - getPadding() - 1, 0, colorWidth);
            int dragY = Mth.clamp(mouseY - getY() - offset, 0, colorWidth);
            ...
            // hue slider
            for(float i = 0; i < colorWidth; i+= 0.5f) Renderer2D.renderQuad(context, getX() + getWidth() - getPadding() - 9, getY() + offset + i, getX() + getWidth() - getPadding() - 1, getY() + offset + i + 0.5f, Color.getHSBColor(i / colorWidth, 1.0f, 1.0f));
            Renderer2D.renderOutline(context, getX() + getWidth() - getPadding() - 9, getY() + offset, getX() + getWidth() - getPadding() - 1, getY() + offset + colorWidth, outlineColor);
            ...
            Renderer2D.renderQuad(context, getX() + getWidth() - getPadding() - 10, getY() + offset + dragHue - 1.5f, getX() + getWidth() - getPadding(), getY() + offset + dragHue + 1.5f, outlineColor);
            Renderer2D.renderQuad(context, getX() + getWidth() - getPadding() - 9, getY() + offset + dragHue - 0.5f, getX() + getWidth() - getPadding() - 1, getY() + offset + dragHue + 0.5f, Color.WHITE);
            ...
            // color slider
            Renderer2D.renderSidewaysGradient(context, getX() + getPadding() + 1, getY() + offset, getX() + getPadding() + 1 + colorWidth, getY() + offset + colorWidth, Color.WHITE, realColor);
            Renderer2D.renderGradient(context, getX() + getPadding() + 1, getY() + offset, getX() + getPadding() + 1 + colorWidth, getY() + offset + colorWidth, new Color(0, 0, 0, 0), Color.BLACK);
            Renderer2D.renderOutline(context, getX() + getPadding() + 1, getY() + offset, getX() + getPadding() + 1 + colorWidth, getY() + offset + colorWidth, outlineColor);
            ...
            Renderer2D.renderQuad(context, getX() + getPadding() + 1 + dragSaturation - 1.5f, getY() + offset + dragBrightness - 1.5f, getX() + getPadding() + 1 + dragSaturation + 1.5f, getY() + offset + dragBrightness + 1.5f, outlineColor);
            Renderer2D.renderQuad(context, getX() + getPadding() + 1 + dragSaturation - 0.5f, getY() + offset + dragBrightness - 0.5f, getX() + getPadding() + 1 + dragSaturation + 0.5f, getY() + offset + dragBrightness + 0.5f, Color.WHITE);
            ...
            // alpha slider
            Renderer2D.renderSidewaysGradient(context, getX() + getPadding() + 1, getY() + offset, getX() + getPadding() + 1 + colorWidth, getY() + offset + 8, Color.BLACK, ColorUtils.getColor(setting.getColor(), 255));
            Renderer2D.renderOutline(context, getX() + getPadding() + 1, getY() + offset, getX() + getPadding() + 1 + colorWidth, getY() + offset + 8, outlineColor);
            hoveringAlpha = isHoveringComponent(mouseX, mouseY, getX() + getPadding() + 1, getY() + offset, getX() + getPadding() + 1 + colorWidth, getY() + offset + 8);

            Renderer2D.renderQuad(context, getX() + getPadding() + 1 + dragAlpha - 1.5f, getY() + offset - 1, getX() + getPadding() + 1 + dragAlpha + 1.5f, getY() + offset + 9, outlineColor);
            Renderer2D.renderQuad(context, getX() + getPadding() + 1 + dragAlpha - 0.5f, getY() + offset, getX() + getPadding() + 1 + dragAlpha + 0.5f, getY() + offset + 8, Color.WHITE);
            ...
            // copy button
            Renderer2D.renderQuad(context, getX() + getPadding() + 1, getY() + offset, getX() + (getWidth()/2f) - 0.5f, getY() + offset + getParent().getHeight(), ClickGuiScreen.getButtonColor(getY(), 100));
            EUClient.FONT_MANAGER.drawTextWithShadow(context, "Copy", getX() + getPadding() + (getWidth()/4) - 1 - EUClient.FONT_MANAGER.getWidth("Copy")/2, getY() + offset + 2, Color.WHITE);
            ...
            // paste button
            Renderer2D.renderQuad(context, getX() + (getWidth()/2f) + 0.5f, getY() + offset, getX() + getWidth() - getPadding() - 1, getY() + offset + getParent().getHeight(), ClickGuiScreen.getButtonColor(getY(), 100));
            EUClient.FONT_MANAGER.drawTextWithShadow(context, "Paste", getX() + (getWidth()/2) + (getWidth()/4) - 1 - EUClient.FONT_MANAGER.getWidth("Paste")/2, getY() + offset + 2, Color.WHITE);
    ...
    public void mouseClicked(double mouseX, double mouseY, int button) {
        ...
        if(button == 0) {
            ...
            if(hoveringCopy) {
                EUClient.CLICK_GUI.setColorClipboard(setting.getValue().getColor());
                playClickSound();
            }
            if(hoveringPaste && EUClient.CLICK_GUI.getColorClipboard() != null) {
                setting.setColor(EUClient.CLICK_GUI.getColorClipboard());
                hsb = Color.RGBtoHSB(setting.getColor().getRed(), setting.getColor().getGreen(), setting.getColor().getBlue(), null);
                playClickSound();
            }
