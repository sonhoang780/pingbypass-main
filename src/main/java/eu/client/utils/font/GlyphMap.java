...
public class GlyphMap {
    ...
    /** Registered atlas id for the immediate (world/nametag) render path; the retained GUI path binds the texture view directly. */
    ...
    private void privateGenerate() {
        ...
        DynamicTexture texture = new DynamicTexture(() -> "euclient/glyph_page_" + page, image);
